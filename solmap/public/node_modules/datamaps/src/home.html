...
window.setTimeout(function() {
        ...
        world.arc([
            {origin: {latitude: 30.29, longitude: -97.738}, destination: {longitude: 35.99, latitude: -107.7}}
        ]);
        ...
        <svg width="500" height="500">
            <path class="squiggles" style="stroke:black;fill:none;" stroke="black" d="M0,250Q250,125,250,250"></path>
        </svg>
    </body>
</html>
